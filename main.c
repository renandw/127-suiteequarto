...
// The  GPIO pin that is connected to the toggle.
#define TOGGLE_PIN 5
#ifndef TOGGLE_PIN
...
homekit_accessory_t *accessories[] = {
    HOMEKIT_ACCESSORY(
	    ...
	    HOMEKIT_CHARACTERISTIC(NAME, "Quarto"),
	    &switch_on_1,
      ...
      &ota_trigger,
        ...
        HOMEKIT_SERVICE(OUTLET, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, "Banheiro"),
            &switch_on_3,
            HOMEKIT_CHARACTERISTIC(OUTLET_IN_USE, true),
            NULL
        }),
      ...
      HOMEKIT_ACCESSORY(
        ...
        HOMEKIT_SERVICE(OUTLET, .characteristics=(homekit_characteristic_t*[]){
            HOMEKIT_CHARACTERISTIC(NAME, "Closet"),
            &switch_on_5,
            HOMEKIT_CHARACTERISTIC(OUTLET_IN_USE, true),
            NULL
        }),
...
void user_init(void) {
    ...
    if (button_create(BUTTON_PIN, config, button_callback_1, NULL)) {
        printf("Failed to initialize button\n");
    }
